...
Par exemple, inclure les méthodes de nettoyage et d’analyse ; les codes et/ou algorythmes ; les procédés d’anonymisation ou de pseudonymisation pour les données sensibles concernant les humains ou des espèces menacées>
